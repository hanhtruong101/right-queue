...
<header className="fixed inset-x-0 top-0 z-50 border-b border-[#D9E3F0] bg-white">
      ...
      >
        ...
        <button
          type="button"
          className="rounded-md cursor-pointer border border-[#2F5E9E] px-4 py-2 text-sm font-semibold text-[#2F5E9E] transition-colors hover:bg-[#F3F7FC] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2F5E9E] focus-visible:ring-offset-2"
